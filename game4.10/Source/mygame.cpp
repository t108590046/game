...
void CGameStateRun::OnBeginState()
{
	...
	//所有槌子的座標 {延遲,x,y}
	int allHammer[3][15][3] = {{},
	                           {{0,1100,965},{0,1153,965},{1,1340,965},{1,1393,965},{2,1446,965},{2,1552,965},{2,1605,965},{3,1658,965},{3,1711,965},{0,2280,680},{1,2227,680},{2,2174,680},{2,2227,470},{3,2280,470},{2,2333,470}},
	                           {}};
